...
- リリース要件: `docs/releases/`（`release-1-single-machine-wedge/`・`release-2-biome-migration/`・`release-3-multi-device-pairing/`）
- 既知の課題: `docs/releases/release-1-single-machine-wedge/known-issues.md`
